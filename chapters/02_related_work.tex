...
% \begin{enumerate}
%     \item Introduction why generative models for comrpessed sensing make sensitive
%     \item Introduce that in this thesis the main focus will be the work by Bora et al
%     \item This work focuses on GAN type models, i.e. VAE and GANs
%     \item Mention that there are other approaches like score based models with denoising and many different generative models
%     \item Explain what GAN type models are
%     \item Explain what the range of a generator is
%     \item Explain the work by Bora et al.
%     \item Explain the small improvement to Bora et al. work with the sparse offset
% \end{enumerate}
