...
% \subsubsection{Composition Into Sectors}
...
The latent variable is initialized with a random $z ~ N(0, 1)$. 

In the case of total emission reconstruction, the generator is redefined as the sum of sectors.
This means that the output of the model is an actual decomposition into sectors.
However, the output of the solver will be the sum of those sectors.
...
The latent variable is initialized with a zero vector.
