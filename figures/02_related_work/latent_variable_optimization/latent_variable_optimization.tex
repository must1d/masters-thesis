...
% Arrows
\draw[arrow] (A) node[left, above] {$z_0 \in \mathbb{R}^d$} -- (generator.west) node[midway, above] (middle_left) {};
\draw[arrow] (generator.east) -- (B) node[midway, above] (middle_right) {$\hat{x}_i \in \mathbb{R}^n$};
